...
export default function Footer() {
  const link = 'text-zinc-400 hover:text-white transition-colors duration-200';
  ...
  return (
    <footer className="relative w-full border-t border-zinc-800 bg-[#0a0b0f] text-zinc-200">
      ...
      <div
        className="pointer-events-none absolute inset-x-0 -top-6 h-6 bg-gradient-to-b from-white/10 to-transparent dark:from-white/5"
        aria-hidden
      />
      <div className="mx-auto max-w-7xl px-6 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" className="text-white">
              ...
              <path
                d="M6 9h6.5a3.5 3.5 0 0 1 0 7H6V9zm3 3v3h3.5a1.5 1.5 0 0 0 0-3H9z"
                fill="currentColor"
              />
            </svg>
          ...
          <div className="mt-5 flex items-center gap-4">
            <Link aria-label="X" href="https://x.com" target="_blank" className="group" rel="noopener noreferrer">
              <XIcon className={glow} />
            </Link>
            <Link aria-label="Facebook" href="https://facebook.com" target="_blank" className="group" rel="noopener noreferrer">
              <FacebookIcon className={glow} />
            </Link>
            <Link aria-label="LinkedIn" href="https://www.linkedin.com" target="_blank" className="group" rel="noopener noreferrer">
              <LinkedInIcon className={glow} />
            </Link>
            <Link aria-label="Instagram" href="https://www.instagram.com" target="_blank" className="group" rel="noopener noreferrer">
              <InstagramIcon className={glow} />
            </Link>
            <Link aria-label="YouTube" href="https://www.youtube.com" target="_blank" className="group" rel="noopener noreferrer">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a className={link} href="https://anpc.ro/" target="_blank" rel="noopener noreferrer">
                ANPC — Protecția Consumatorilor
              </a>
            </li>
            <li>
              <Link className={link} href="/politica-confidentialitate">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link className={link} href="/ghiduri">
                Ghiduri &amp; FAQ
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="mt-3 text-xs text-zinc-300 leading-5">
            Conținut comercial. Ofertele sunt doar pentru operatori licențiați ONJN. Joacă
            responsabil. Jocurile de noroc implică riscuri financiare.
          </p>
          <p className="mt-2 text-xs text-zinc-300 leading-5">
            Bonusmax nu este o casă de pariuri sau un operator de jocuri de noroc. Conținutul de pe
            acest site are scop exclusiv informativ și nu reprezintă recomandări financiare sau
            juridice.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-zinc-700 px-3 py-1">
      <svg width="20" height="20" viewBox="0 0 24 24" className="text-white">
        ...
        <text x="50%" y="56%" textAnchor="middle" fontSize="11" fill="white" fontWeight="700">
          18+
        </text>
      </svg>
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-zinc-700 px-3 py-1">
      <svg width="20" height="20" viewBox="0 0 24 24" className="text-white">
        ...
        />
        <path
          d="M12 5.2l5 2.1v3.6c0 3.6-2.3 6.7-5 7.8-2.7-1.1-5-4.2-5-7.8V7.3l5-2.1z"
          stroke="currentColor"
          strokeWidth="1.2"
          fill="none"
        />
