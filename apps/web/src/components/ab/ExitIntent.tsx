...
export default function ExitIntent({
  ...
  function ping() {
    ...
    fetch('/api/ui/impression', {
      ...
      body: JSON.stringify({
        component: 'exit_modal',
        experimentKey: 'EXIT_INTENT_V1',
        variant,
        path,
        sessionId: sid,
      }),
    ...
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/40">
      <div className="w-[92%] max-w-md rounded-2xl border bg-white p-5 shadow-xl">
        ...
        <p className="mt-1 text-sm opacity-80">
          Operator licenÃˆâ€ºiat ONJN. CiteÃˆâ„¢te termenii ÃƒÂ®nainte de a juca.
        </p>
        <a
          href={ctaHref}
          className="mt-3 inline-block rounded-lg border px-4 py-2 font-semibold underline"
        >
          Deschide oferta
        </a>
        <p className="mt-2 text-xs opacity-60">
          ConÃˆâ€ºinut comercial Ã¢â‚¬Â¢ 18+ JoacÃ„Æ’ responsabil.
        </p>
