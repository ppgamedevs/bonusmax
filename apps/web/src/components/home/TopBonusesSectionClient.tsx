  ...
  switch (key) {
    case 'no_deposit':
      return list
        .filter(
          (o) =>
            o.offerType === 'FARA_DEPUNERE' ||
            (typeof o.minDeposit === 'number' && o.minDeposit === 0)
        )
  ...
  return (
    <div className="mt-2">
      ...
      <div className="mb-2 flex flex-wrap items-center gap-2">
        {(
          [
            { key: 'popular', label: 'Cele mai populare' },
            { key: 'no_deposit', label: 'Cel mai bun Fără Depunere' },
            { key: 'highest_value', label: 'Cea mai bună valoare' },
