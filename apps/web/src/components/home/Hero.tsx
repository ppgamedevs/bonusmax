  ...
  return (
    <section className="container mx-auto px-4 pt-8 pb-6 text-center">
      ...
      <div className="mt-3 flex items-center justify-center gap-4 text-[12px] opacity-80">
        <span className="inline-flex items-center gap-1"><ShieldCheck size={14} aria-hidden /> ONJN</span>
        <span className="inline-flex items-center gap-1"><Lock size={14} aria-hidden /> SSL securizat</span>
        <span className="inline-flex items-center gap-1"><BadgeAlert size={14} aria-hidden /> 18+ responsabil</span>
      </div>
