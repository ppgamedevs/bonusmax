  ...
  return (
    <section className="mx-auto mt-8 max-w-6xl px-4">
      <header className="mb-3">
        ...
        <p className="mt-1 text-sm opacity-70">Sfaturi rapide pentru bonusuri, termeni și strategii responsabile.</p>
      </header>
      <div className="grid gap-3 sm:grid-cols-3">
        <a href="/ghiduri" className="rounded-xl border border-white/15 p-4 hover:bg-white/5">
          ...
          <p className="mt-1 text-xs opacity-70">Ce înseamnă x30, x40 și cum calculezi rulajul corect.</p>
        </a>
        <a href="/ghiduri" className="rounded-xl border border-white/15 p-4 hover:bg-white/5">
          <div className="text-sm font-semibold">Bonusuri fără depunere: ce trebuie să știi</div>
          <p className="mt-1 text-xs opacity-70">Când merită, capcane frecvente și cum verifici termenii.</p>
        </a>
        <a href="/ghiduri" className="rounded-xl border border-white/15 p-4 hover:bg-white/5">
      ...
      <div className="mt-3 text-right">
        <a href="/ghiduri" className="text-sm underline">Vezi toate ghidurile →</a>
      </div>
    </section>
  );
}
