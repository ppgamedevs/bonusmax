                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-[11px]">
                            ...
                            {o.isSponsored && <span className="chip-accent">Sponsored</span>}
                          </div>
                        </div>
                        {win && (
                          <span
            ...
            {[
              ...
              <tr
                ...
                className={clsx(
                  ...
                  index % 2 === 0 ? 'bg-white/5 dark:bg-white/5' : 'bg-white/10 dark:bg-black/10'
                )}
              >
            ...
            <tr className="border-t border-white/10 even:bg-white/5 dark:even:bg-white/5">
              ...
              {offers.map((o) => {
                ...
                return (
                  <td key={o.id} className={colClass}>
                    <div className={colWrap(win)}>
                      {o.app ? <span className="text-xs">{o.app}</span> : no}
                    </div>
                  </td>
                );
              })}
