    ...
    <div className="mb-4 flex flex-wrap items-center gap-2">
      <form action={basePath} className="flex flex-wrap items-end gap-2">
        ...
        <div className="flex flex-col">
          ...
          <select name="sort" defaultValue={sort} className="rounded border bg-transparent px-3 py-2 text-sm">
        ...
        <div className="flex flex-col">
          ...
          <input type="number" name="min_wr" defaultValue={currentMinWr ?? ""} placeholder="ex: 20" className="w-28 rounded border bg-transparent px-3 py-2 text-sm" />
        </div>
        <div className="flex flex-col">
          <label className="text-xs opacity-70">WR maxim</label>
          <input type="number" name="max_wr" defaultValue={currentMaxWr ?? ""} placeholder="ex: 35" className="w-28 rounded border bg-transparent px-3 py-2 text-sm" />
        </div>
        <div className="flex flex-col">
