...
export default async function CtaOffer({ id }: { id: string }) {
  ...
  return (
    <section className="mt-6">
      <h3 className="text-base font-semibold">OfertÃƒâ€žÃ†â€™ relevantÃƒâ€žÃ†â€™</h3>
      <div className="mt-2">
        
        <OfferCard offer={offer as any} />
      </div>
      <p className="mt-2 text-xs opacity-60">ConÃƒË†Ã¢â‚¬Âºinut comercial ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ 18+ JoacÃƒâ€žÃ†â€™ responsabil.</p>
    </section>
  );
}
