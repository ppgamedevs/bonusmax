...
export default function Hero({ updated }: { updated: string }) {
  const title = `Top oferte licențiate ONJN — actualizat azi, ${updated}`;
  const subtitle = "Comparați bonusuri verificate, cu termeni clari. 18+ Joacă responsabil.";
  return (
    <section className="mx-auto max-w-5xl px-4 pt-10 pb-6 text-center">
      <p className="text-xs uppercase tracking-wide opacity-60">Conținut comercial</p>
      ...
      <div className="mt-5 flex justify-center gap-3">
        ...
        <a href="/bonusuri-fara-depunere" className="inline-flex h-11 items-center justify-center rounded-xl border px-4 text-sm">Bonus fără depunere</a>
