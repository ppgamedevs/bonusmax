...
export function BetanoIcon({ className = "", title = "Betano (placeholder)" }: IconProps) {
  return (
    ...
    >
      ...
      {/* Stylized ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œBÃƒÂ¢Ã¢â€šÂ¬Ã‚Â mark */}
      <path
...
export function NetBetIcon({ className = "", title = "NetBet (placeholder)" }: IconProps) {
  return (
    ...
    >
      ...
      {/* Soft container */}
      <rect x="4" y="4" width="40" height="40" rx="12" fill="currentColor" opacity=".08" />
      {/* ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œNBÃƒÂ¢Ã¢â€šÂ¬Ã‚Â monogram */}
      <path
...
export function SuperbetIcon({ className = "", title = "Superbet (placeholder)" }: IconProps) {
  return (
    ...
    >
      ...
      {/* Soft container */}
      <rect x="4" y="4" width="40" height="40" rx="12" fill="currentColor" opacity=".08" />
      {/* Stylized ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œSÃƒÂ¢Ã¢â€šÂ¬Ã‚Â in a ball */}
...
export function BonusCardHeader() {
  return (
    <div className="group flex items-center justify-between">
      ...
      {/* glow CTA on hover of the whole card */}
      <button
...
ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œUse the SVG components above as placeholders for operator logos. Keep them monochrome (text-zinc-400) and apply hover glow via parent .group.ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œThese are not official marks; replace paths later with provided brand SVGs without changing the API.ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œIcons must respect currentColor. On hover, color becomes white and a soft drop-shadow simulates glow.ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
*/
