...
export default async function Page({
  ...
  return (
    <main className="container mx-auto px-4 py-8" id="main">
      <h1 className="text-2xl font-bold mb-4">Bonusuri fără depunere</h1>
      <DisclosureBar />
      {/* Sponsored strip (kept for visibility); the list below is also pinned */}
      <PromoStrip slot="HUB_FARA_DEP" title="Sponsored • Bonus fără depunere" />
      <FilterBar
        ...
        <table className="w-full text-sm">
          <thead>
            <tr>
              ...
              <th className="p-2">Min depunere</th>
