...
export default async function Page() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <p className="mt-2 text-sm opacity-80">Listă informativă bazată pe datele noastre. Verifică întotdeauna site-ul ONJN pentru actualizări. 18+ Joacă responsabil.</p>
        ...
        <tbody>
          {ops.map((o: any) => (
            <tr key={o.id} className="border-t">
              ...
              <td className="p-2">{o.website ? <a className="underline" href={o.website} rel="nofollow">site</a> : "—"}</td>
              <td className="p-2">{o.onjnLicenseId || "—"}</td>
              <td className="p-2">{o.onjnLicenseExpiry ? new Date(o.onjnLicenseExpiry).toLocaleDateString("ro-RO") : "—"}</td>
            </tr>
          ))}
        </tbody>
      </table>
