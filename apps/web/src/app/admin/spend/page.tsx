  ...
  return (
    <Guard keyParam={keyParam}>
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold">Admin — Spend</h1>
        <form action={createSpend} className="mt-4 grid gap-2 md:grid-cols-4">
          ...
          <input
            ...
            name="source"
            placeholder="sursă (ex: google)"
            required
          />
          <input
            className="rounded border px-3 py-2"
            name="campaign"
            placeholder="campanie (opțional)"
          />
          <input
            className="rounded border px-3 py-2"
            type="number"
            ...
            placeholder="RON"
          />
          <button className="rounded border px-3 py-2 font-semibold md:col-span-4" type="submit">
            Adaugă
          </button>
        </form>
