    ...
    <Guard keyParam={keyParam}>
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border p-4"><div className="text-xs opacity-70">EPC / CVR</div><div className="text-2xl font-bold">{o.epc.toFixed(2)} RON <span className="text-sm opacity-70">ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ {(o.cvr*100).toFixed(2)}%</span></div></div>
        </section>

        <section className="mt-8">
          <h2 className="text-lg font-semibold">Top pages ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ EPC (min 10 clicks)</h2>
          <table className="mt-2 w-full text-sm">
            <thead><tr><th className="p-2 text-left">PaginÃƒâ€žÃ†â€™</th><th className="p-2 text-center">Clicks</th><th className="p-2 text-right">Revenue</th><th className="p-2 text-right">EPC</th></tr></thead>
            <tbody>
              {pages.map((r:any)=> (
              ...
              {pages.length===0 && <tr><td className="p-2" colSpan={4}>Nimic ÃƒÆ’Ã‚Â®ncÃƒâ€žÃ†â€™ (ai nevoie de clicks).</td></tr>}
            </tbody>
          </table>
        </section>
        ...
        <section className="mt-8">
          ...
          <table className="mt-2 w-full text-sm">
            <thead><tr><th className="p-2 text-left">source</th><th className="p-2">medium</th><th className="p-2">campaign</th><th className="p-2 text-center">Clicks</th><th className="p-2 text-right">Revenue</th><th className="p-2 text-right">EPC</th></tr></thead>
            <tbody>
              {utm.map((r:any)=> (
              ...
              {utm.length===0 && <tr><td className="p-2" colSpan={6}>Nimic ÃƒÆ’Ã‚Â®ncÃƒâ€žÃ†â€™.</td></tr>}
            </tbody>
          </table>
        </section>
      </main>
