  ...
  if (ids.length === 0) {
    return (
      <main className="container mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold">ComparaÃƒÆ’Ã‹â€ ÃƒÂ¢Ã¢â€šÂ¬Ã‚Âºie</h1>
        <p className="mt-2 text-sm opacity-80">SelecteazÃƒÆ’Ã¢â‚¬Å¾Ãƒâ€ Ã¢â‚¬â„¢ oferte cu butonul ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¾ComparaÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â.</p>
        <Link className="mt-4 inline-block text-sm underline" href="/">ÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â½napoi la homepage</Link>
        <PopulateFromLocal />
      </main>
    );
  }
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mt-2 flex items-center justify-between">
        <a href="#main" className="text-sm underline">ÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â½napoi sus</Link>
        <Link href="/" className="text-sm underline">ÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â½napoi la homepage</Link>
      </div>
