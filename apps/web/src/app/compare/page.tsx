  ...
  if (ids.length === 0) {
    return (
      <main className="container mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold">Comparație</h1>
        <p className="mt-2 text-sm opacity-80">Selectează oferte cu butonul „Compara”.</p>
        <a className="mt-4 inline-block text-sm underline" href="/">Înapoi la homepage</a>
        <PopulateFromLocal />
      </main>
    );
  }
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <a href="/" className="text-sm underline">Înapoi la homepage</a>
      </div>
